...
@Preview(name = "Sign in light theme", uiMode = UI_MODE_NIGHT_NO, widthDp = 500)
@Preview(name = "Sign in dark theme", uiMode = UI_MODE_NIGHT_YES, widthDp = 500)
@Composable
fun SignInPreview() {
    JetsurveyTheme {
        SignInScreen(
